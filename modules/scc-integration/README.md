...
| <a name="requirement_google-beta"></a> [google-beta](#requirement\_google-beta) | ~> 7.26.0 |
...
| <a name="provider_google-beta"></a> [google-beta](#provider\_google-beta) | ~> 7.26.0 |
...
| [google_logging_project_sink.gke_events](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/logging_project_sink) | resource |
...
| <a name="input_log_sync_type"></a> [log\_sync\_type](#input\_log\_sync\_type) | Whether to create the log sync at the Project, Folder, or Organization level | `string` | `"PROJECT"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_log_sink"></a> [log\_sink](#output\_log\_sink) | The Org sink for log streaming |
