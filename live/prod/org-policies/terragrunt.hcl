...
inputs = {
  // Reference your shared list of boolean Org Policies to disable for the project here
  boolean_policies_to_disable = local.common_vars.inputs.boolean_policies_to_disable

  // Reference your shared list of list constraint Org Policies to disable for the project here
